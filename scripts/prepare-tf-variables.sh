...
export TF_VAR_embeddingsDeploymentCapacity=240
...
export TF_VAR_enableBingSafeSearch=true
export TF_VAR_azure_environment=$AZURE_ENVIRONMENT
export TF_VAR_is_secure_mode=$SECURE_MODE
export TF_VAR_enableWebChat=true
export TF_VAR_enableUngroundedChat=true
export TF_VAR_enableMathAssitant=true
export TF_VAR_enableTabularDataAssistant=true
export TF_VAR_enableSharePointConnector=true
export TF_VAR_enableMultimedia=true
